...
- O agendador (Celery beat ou script `run_carga_scheduler.py`) verifica periodicamente os parâmetros ativos e, no horário configurado, processa os XMLs do diretório (extrai ZIPs, detecta NFe/CTe/NFSe e grava no banco). Arquivos processados podem ser movidos para subpastas “processados” ou “pendentes”.
