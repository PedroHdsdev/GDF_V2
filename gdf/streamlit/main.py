...
def init_django():
    # __file__ = .../gdf/streamlit/main.py
    streamlit_dir = os.path.dirname(os.path.abspath(__file__))
    base_dir = os.path.dirname(streamlit_dir)  # projeto (onde estão manage.py e app/)

    # Django precisa do diretório do projeto em sys.path para importar config.settings
