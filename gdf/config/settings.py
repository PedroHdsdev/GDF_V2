"""
Django settings for the GDF project.
...
_coop = (env('SECURE_CROSS_ORIGIN_OPENER_POLICY', default='same-origin') or '').strip().lower()
SECURE_CROSS_ORIGIN_OPENER_POLICY = None if _coop in {'', 'none', 'off', 'false'} else _coop
