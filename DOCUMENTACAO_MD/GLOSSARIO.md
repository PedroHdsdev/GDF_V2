...
**Parâmetro carga XML**  
Configuração de carga automática de XML: diretório, horário, empresa, cliente e origem (LOCAL, SAP, SPED, OUTROS). Modelo: `ParametroCargaXml`. O Celery beat (ou run_carga_scheduler) processa esse diretório no horário definido.
